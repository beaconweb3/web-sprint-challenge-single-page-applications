...
const App = () => {
  ...
  return (
    <BrowserRouter>
      <div id='Title' style={{...style,  margin: '1rem', padding: '0 0.5rem', justifyContent: 'space-between'}}>
      ...
      <div id='main' style={{...style,   margin: '1rem', padding: '5rem 0', flexDirection: 'column', textAlign: 'center'}}>
